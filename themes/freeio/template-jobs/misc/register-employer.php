  	...
  	<div class="container-form">
		...
		<?php endif; ?>
  		...
  		<?php
		   ...
		   $html_output .= '<div class="form-group" id="username">
		   <label for="_employer_adress">'.__('address:', 'wp-freeio').'</label>
		   <input type="text" name="_employer_adress" id="_employer_adress" class="form-control" placeholder="your address" required>
		</div>';
