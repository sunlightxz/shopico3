	...
	<div class="widget widget-packages widget-subwoo m-0">
		...
		<div class="row">
			<?php foreach ( $packages as $key => $package ) :
				...
				if ( ! $product->is_type( array( 'project_package', 'project_package_subscription' ) ) || ! $product->is_purchasable() ) {
					continue;
				}
				?>
						...
						<div class="item">
							...
							<div class="bottom-sub">
                                ...
                                <div class="button-action">
                                	<div class="add-cart">
	                                	<button class="button btn" type="submit" name="wpfiwpl_project_package" value="<?php echo esc_attr($product->get_id()); ?>" id="package-<?php echo esc_attr($product->get_id()); ?>">
