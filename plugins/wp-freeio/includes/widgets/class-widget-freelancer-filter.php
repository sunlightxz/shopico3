...
class WP_Freeio_Widget_Freelancer_Filter extends WP_Widget {
	/**
	 * Initialize widget
	 *
	 * @access public
	...
	function __construct() {
		parent::__construct(
			'freelancer_filter_widget',
			__( 'Freelancer Filter', 'wp-freeio' ),
			array(
				'description' => __( 'Filter for filtering freelancers.', 'wp-freeio' ),
			)
		);
	}
	...
	function widget( $args, $instance ) {
		include WP_Freeio_Template_Loader::locate( 'widgets/freelancer-filter' );
	}
	...
	function form( $instance ) {
		...
		<ul class="wp-freeio-filter-fields wp-freeio-filter-freelancer-fields">
			<?php

			$all_fields = $fields = WP_Freeio_Freelancer_Filter::get_fields();
			if ( ! empty( $sort ) ) {
		...
		<script type="text/javascript">
			jQuery(document).ready(function($) {
				$('.widget .wp-freeio-filter-freelancer-fields').each(function() {
					var el = $(this);
...
register_widget('WP_Freeio_Widget_Freelancer_Filter');