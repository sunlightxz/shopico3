                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td valign="top">Hello
                                                            ...
                                                            Your Service "{{service_title}}" is Expired you can renew this services by login to your Employer account go to Manage Services &gt; find your services from listings "{{service_title}}" Edit your service select package on step 2 and update your service by this ways your services will be publish again.

                                                            Visit the <a href="{{dashboard_url}}">service listing dashboard</a> to manage the listing.
