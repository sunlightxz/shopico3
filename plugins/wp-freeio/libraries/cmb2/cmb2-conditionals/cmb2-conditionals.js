jQuery( document ).ready( function( $ ) {
	...
	function CMB2ConditionalsInit( changeContext, conditionContext ) {
		 ...
		 */
		changeContext.on( 'change', 'form.cmb-form input, form.cmb-form textarea, form.cmb-form select', function( evt ) {
			var elm       = $( this ),
		...
		uniqueFormElms = [];
		$( 'form.cmb-form :input', changeContext ).each( function( i, e ) {
