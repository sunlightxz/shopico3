...
class WP_Freeio_CMB2_Field_Datepicker {

	public static function init() {
		add_filter( 'cmb2_render_wpfi_datepicker', array( __CLASS__, 'render_map' ), 10, 5 );
		add_filter( 'cmb2_sanitize_wpfi_datepicker', array( __CLASS__, 'sanitize_map' ), 10, 4 );
	}
	...
	public static function render_map( $field, $field_escaped_value, $field_object_id, $field_object_type, $field_type_object ) {
		...
		echo $field_type_object->input( array(
			...
			'value'      => $value,
			'class'      => 'wpfi-datepicker cmb2-datepicker',
			'desc'       => '',
...
WP_Freeio_CMB2_Field_Datepicker::init();