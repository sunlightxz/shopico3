	    ...
	    <form id="job-apply-email-form-<?php echo esc_attr($post->ID); ?>" class="job-apply-email-form" method="post" action="" enctype="multipart/form-data">
	    	<div class="row">
	    		...
	    		<?php if ( is_array($cv_attachments) ) { ?>
			        <div class="col-xs-12">
			        	<div class="file-or-upload"><?php esc_html_e('Select a your CV', 'wp-freeio'); ?></div>
		        ...
		        <div class="col-xs-12">
			        <div class="form-group">
			            <input type="text" class="form-control style2" name="fullname" placeholder="<?php esc_attr_e( 'Full Name', 'wp-freeio' ); ?>" required="required">
			        </div><!-- /.form-group -->
			    </div>
			    <div class="col-xs-12">
			        <div class="form-group">
			            <input type="email" class="form-control style2" name="email" placeholder="<?php esc_attr_e( 'E-mail', 'wp-freeio' ); ?>" required="required">
			        </div><!-- /.form-group -->
			    </div>
			    <div class="col-xs-12">
			        <div class="form-group">
			            <input type="text" class="form-control style2" name="phone" placeholder="<?php esc_attr_e( 'Phone', 'wp-freeio' ); ?>">
			        </div><!-- /.form-group -->
			    </div>
			    <div class="col-xs-12">
