	...
	<section id="primary" class="content-area">
		<main id="main" class="site-main content" role="main">
			<?php if ( have_posts() ) : ?>
							...
							<?php
								...
								switch ($restrict_detail) {
									...
									case 'register_freelancer':
										?>
										<h2 class="restrict-title"><?php echo __( 'Please login as freelancer to view employer.', 'wp-freeio' ); ?></h2>
										<?php
										break;
									default:
				...
				?>
						<?php echo WP_Freeio_Template_Loader::get_template_part( 'content-single-employer' ); ?>
				<?php
					}
				endwhile; ?>
