...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="row">
		<div class="col-sm-9">
			...
			<!-- profile photos -->
			<?php echo WP_Freeio_Template_Loader::get_template_part( 'single-employer/profile-photos' ); ?>

			<!-- team member -->
			<?php echo WP_Freeio_Template_Loader::get_template_part( 'single-employer/members' ); ?>

			<!-- Socials -->
			<?php echo WP_Freeio_Template_Loader::get_template_part( 'single-employer/socials' ); ?>

			<!-- job releated -->
			<?php echo WP_Freeio_Template_Loader::get_template_part( 'single-employer/open-jobs' ); ?>

			<?php if ( (comments_open() || get_comments_number()) && WP_Freeio_Employer::check_restrict_review($post) ) : ?>
				<!-- Review -->
		...
		<div class="col-sm-3">
			...
			<!-- job detail -->
			<?php echo WP_Freeio_Template_Loader::get_template_part( 'single-employer/detail' ); ?>
			<!-- job detail -->
			<?php echo WP_Freeio_Template_Loader::get_template_part( 'single-employer/map-location' ); ?>
			
			<?php echo WP_Freeio_Template_Loader::get_template_part( 'single-employer/contact-form' ); ?>
