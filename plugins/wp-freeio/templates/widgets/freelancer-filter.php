...
<form method="get" action="<?php echo WP_Freeio_Mixes::get_freelancers_page_url(); ?>" class="filter-freelancer-form filter-listing-form">
	...
	<?php if ( ! empty( $instance['button_text'] ) ) : ?>
		<div class="form-group">
			<button class="button"><?php echo esc_attr( $instance['button_text'] ); ?> <i class="ti-angle-right"></i></button>
		</div><!-- /.form-group -->
	<?php endif; ?>
</form>
